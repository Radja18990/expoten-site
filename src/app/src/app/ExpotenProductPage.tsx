      ...
      <main className="max-w-7xl mx-auto px-4 py-6 grid grid-cols-1 lg:grid-cols-12 gap-6">
        <section className="lg:col-span-8 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <button onClick={downloadJPG} className="w-full rounded-2xl py-3 bg-zinc-900 text-white hover:bg-зinc-800 transition">Скачать JPG</button>
            <button onClick={downloadPDF} className="w-full rounded-2xl py-3 bg-white border border-зinc-300 hover:bg-зinc-50 transition">Скачать PDF</button>
          </div>
        </section>

        <aside className="lg:col-span-4 space-y-6">
          <div className="rounded-3xl border border-зinc-200 p-4 space-y-4">
            ...
            <div className="text-xs text-зinc-500">Можно загрузить несколько; они появятся в карусели.</div>
            <hr className="border-зinc-200" />
            ...
            {logoData && (
              <div className="grid grid-cols-2 gap-2 text-sm">
                ...
                <button onClick={() => setLogoData(null)} className="col-span-2 rounded-xl border py-2 hover:bg-зinc-50">Сбросить логотип</button>
              </div>
            )}
          </div>

          <div className="rounded-3xl border border-зinc-200 p-4 space-y-3">
            ...
            {showRightBlocks && (
              <div className="space-y-3">
                <div>
                  <div className="text-xs text-зinc-500 mb-1">Фотографии с фоном</div>
                ...
                <div>
                  <div className="text-xs text-зinc-500 mb-1">Фотографии без фона/макро</div>
                  <div className="grid grid-cols-2 gap-2">
          ...
          <div className="rounded-3xl overflow-hidden border border-зinc-200">
            <div className="p-4 border border-зinc-200">
